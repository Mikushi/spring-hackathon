<html>
	...
	<body>
    		<div class="container animated fadeInDown">
				...
				<center>
					<input id="search" type="text" name="search" onclick="this.select();" onfocus="this.select();" onblur="this.placeholder=!this.placeholder?'Type in your postcode and hit enter':this.placeholder;" placeholder="Type in your postcode and hit enter" />
				</center>
